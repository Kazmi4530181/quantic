...
import { faCalendar, faPlus, faBell, faTachometerAlt, faAngleDoubleLeft, faAngleDoubleRight } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className="container-flex">
      <div className={navOpen ? "side-nav side-nav-open" : "side-nav side-nav-close"}>
        <div className={navOpen ? "logo py-3 text-center text-white" : 'd-none'}>Booking System</div>
        <ul className={navOpen ? "nav-items" : 'nav-items-hidden'}>
          ...
          <a className={navOpen ? "d-block" : "d-none"} href="#" onClick={() => { setActiveComponent("calendar"); setActiveLink("calendar"); }}>
            <div className={activeLink === "calendar" ? "nav-item nav-item-active py-2 px-3" : "nav-item nav-item-inactive py-2 px-3"}>
      ...
      <div className="menu d-flex justify-content-center align-items-center">
        <div className="notification d-flex justify-content-center align-items-center gap-3">
          ...
          <div className="d-flex justify-content-center align-items-center gap-2">
            <Avatar alt="John" src={user.avatarUrl} />
